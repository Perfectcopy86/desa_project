...
<html lang="en">
  ...
  <body>
    ...
    <section id="lembagadetail" class="section-padding bg-light">
      <div class="header section-title">Badan Usaha Milik Desa (BumDes)</div>
      <div class="content">
        <img
          alt="Logo of Badan Permusyawaratan Desa"
          height="150"
          src="https://upload.wikimedia.org/wikipedia/commons/5/53/Linmas_Logo.png"
          width="150"
        />
        <div class="details section-title">
          <table>
            <tr>
              <td>Nama Lembaga</td>
              <td>:</td>
              <td>Badan Usaha Milik Desa (BumDes)</td>
            </tr>
            <tr>
              ...
              <td>
                <ol>
                  <li>Undang-Undang Nomor 22 tahun 1999</li>
                  <li>Undang-Undang Nomor 32 tahun 2004</li>
                  <li>Peraturan Pemerintah Nomor 11 tahun 2021</li>
                </ol>
              </td>
            </tr>
            <tr>
      ...
      <div class="table-section">
        Kepengurusan Badan Usaha Milik Desa (BumDes)
        <table>
          <thead>
            <tr>
              <th>Jabatan</th>
          ...
          <tbody>
            <tr>
              <td>Komisaris BumDes</td>
              <td>Didi Supendi
              </td>
            </tr>
            <tr>
              <td>Pengawas Bumdes</td>
              <td><ol>
                    <li>H. Agus Darmawan</li>
                    <li>H. Salim Iskandar</li>
                  </ol> 
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>H. Didi Suryadi Putradinata
              </td>
            </tr>
            <tr>
              <td>Direktur Keuangan</td>
              <td>Hj. Dewi Putri Novitasari
              </td>
            </tr>
            <tr>
              <td>Direktur SDM dan Pemasaran</td>
              <td>Rian Rizky Santoso
              </td>
            </tr>
            <tr>
              <td>Direktur Unit Usaha</td>
              <td>Muhammad Adrian
              </td>
            </tr>
          </tbody>
      ...
      <div class="section">
          Visi &amp; Misi Badan Usaha Milik Desa (BumDes)
          <div class="content-box">
              Visi :<br> "Menjadi lembaga ekonomi desa yang mandiri, berkelanjutan, dan memberikan manfaat optimal bagi kesejahteraan masyarakat desa."
              <br /><br />
              Misi :
              <ol>
                <li>Mengembangkan potensi ekonomi lokal dengan pemanfaatan potensi sumber daya alam dan kearifan lokal untuk menciptakan usaha yang menguntungkan dan berkelanjutan.</li>
                <li>Membuka peluang lapangan kerja dan meningkatkan pendapatan masyarakat melalui pengelolaan usaha yang dikelola oleh BumDes.</li>
                <li>Memperkuat kemandirian ekonomi desa yang menjadi motor penggerak perekonomian desa dengan menjalankan berbagai usaha yang mampu menghasilkan keuntungan bagi pembangunan desa.</li>
                <li>Membangun kemitraan dengan pemerintah, swasta, dan lembaga keuangan untuk mendukung pengembangan usaha BumDes.</li>
                <li>Mengelola BumDes secara transparan, efisien, dan berorientasi pada keberlanjutan usaha yang dapat menguntungkan masyarakat desa.</li>           
              </ol>
          </div>
      </div>
      <div class="section">
        Tugas Pokok &amp; Fungsi Badan Usaha Milik Desa (BumDes)
        <div class="content-box text-justify">
        Untuk mengelola dan mengembangkan usaha ekonomi yang dikelola oleh desa dengan tujuan meningkatkan pendapatan dan kesejahteraan masyarakat desa. BumDes bertugas merencanakan, mengelola, dan memonitor kegiatan usaha yang berbasis pada potensi lokal, seperti pengolahan sumber daya alam, usaha perdagangan, dan jasa yang bermanfaat bagi masyarakat. Selain itu, BumDes berfungsi untuk membuka peluang lapangan kerja, memperkuat perekonomian desa, serta menjalin kemitraan dengan berbagai pihak, baik pemerintah, swasta, maupun lembaga keuangan, untuk mendukung keberlanjutan usaha. BumDes juga memiliki tanggung jawab untuk mengelola usaha secara transparan, profesional, dan akuntabel demi mencapai tujuan kemandirian ekonomi desa yang berkelanjutan.
        </div>
      </div>
      <div class="scroll-up">
