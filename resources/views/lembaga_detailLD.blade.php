...
<html lang="en">
  ...
  <body>
    ...
    <section id="lembagadetail" class="section-padding bg-light">
      <div class="header section-title">Perlindungan Masyarakat</div>
      <div class="content">
        <img
        ...
        <div class="details section-title">
          <table>
            <tr>
              <td>Nama Lembaga</td>
              <td>:</td>
              <td>Perlindungan Masyarakat (Linmas)</td>
            </tr>
            <tr>
              <td>Dasar Hukum / SK Pembentukan</td>
              <td>:</td>
              <td>Peraturan Menteri Dalam Negeri No. 26 Tahun 2020
              </td>
            </tr>
            <tr>
              <td>Alamat Kantor</td>
      ...
      <div class="section">
          Visi &amp; Misi Perlindungan Masyarakat (Linmas)
          <div class="content-box">
              Visi :<br> "Terwujudnya masyarakat desa yang aman, tertib, dan siap siaga dalam menghadapi berbagai tantangan sosial dan bencana."
              <br /><br />
              Misi :
              <ol>
                <li>Membantu menciptakan lingkungan desa yang aman dan tertib melalui patroli rutin, pengawasan, dan pengendalian potensi gangguan sosial.</li>
                <li>Mengedukasi masyarakat tentang pentingnya menjaga keamanan, ketertiban, serta kewaspadaan terhadap potensi ancaman bencana alam atau sosial.</li>
                <li>Melatih dan mempersiapkan masyarakat untuk siap tanggap dalam menghadapi bencana alam, kebakaran, dan kejadian darurat lainnya.</li>
                <li>Menjalin kerja sama yang solid dengan aparat keamanan, pemerintah desa, serta organisasi terkait dalam menjaga ketertiban dan keamanan desa.</li>              
              </ol>
          </div>
      </div>
      <div class="section">
        Tugas Pokok &amp; Fungsi Perlindungan Masyarakat (Linmas)
        <div class="content-box text-justify">
        Menjaga keamanan, ketertiban, dan kedamaian di lingkungan desa melalui pengawasan, patroli, dan upaya pencegahan terhadap gangguan sosial dan bencana. LinMas bertugas untuk memantau situasi keamanan, memberikan bantuan dalam penanggulangan bencana alam, kebakaran, serta kejadian darurat lainnya, serta berperan aktif dalam kegiatan sosial yang mendukung keamanan desa. Selain itu, LinMas juga berfungsi sebagai mitra pemerintah desa dan aparat keamanan dalam menjaga kondusifitas desa, meningkatkan kesadaran masyarakat tentang kewaspadaan, serta memberikan pelatihan kepada anggotanya agar siap siaga dalam menghadapi berbagai tantangan.
