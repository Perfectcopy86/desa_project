  ...
  <body>
    ...
    <section id="home" class="hero-section text-center">
      <div class="container">
        ...
        <h2 class="mb-4">Pemerintahan</h2>
        <a href="#vision" class="btn btn-masuk btn-lg">Learn More</a>
      </div>
    </section>

    <!-- Vision & Mission -->
    <section id="vision" class="section-padding bg-dark">
      <div class="container">
        <div class="row">
            ...
            <div class="card h-100 border-0 shadow">
              <div class="card-body">
                <h2 class="card-title mb-4">
                  <i class="fas fa-eye text-dark me-2"></i>Visi
                </h2>
                <p class="card-text">
                  BERSAMA SAMA MEWUJUDKAN KESEJAHTERAAN DAN KUALITAS HIDUP
                  MASYARAKAT DESA YANG MANDIRI DAN AGAMIS MELALUI
                  PENYELENGGARAAN PEMERINTAHAN DESA YANG HARMONIS TRANSPARAN DAN
                  AKUNTABEL
                </p>
              </div>
            </div>
          ...
          <div class="col-md-6 mb-4">
            <div class="card h-100 border-0 shadow">
              <div class="card-body">
                <h2 class="card-title mb-4">
                  <i class="fas fa-bullseye text-dark me-2"></i>Misi
                </h2>
                <ul class="list-unstyled">
                  <li class="mb-2 d-flex">
                    <i class="fas fa-circle text-dark me-2 mt-1"></i>
                    <span
                      >PENYELENGGARAAN PEMERINTAHAN DESA YANG TRANSPARAN DAN
                      AKUNTABEL SERTA PENINGKATAN KUALITAS DAN AKSES TERHADAP
                      PELAYANAN DASAR</span
                    >
                  </li>
                  <li class="mb-2 d-flex">
                    <i class="fas fa-circle text-dark me-2 mt-1"></i>
                  ...
                  <li class="mb-2 d-flex">
                    <i class="fas fa-circle text-dark me-2 mt-1"></i>
                    <span
                      >PENGEMBANGAN EKONOMI PERTANIAN BERSKALA PRODUKTIF.</span
                    >
                  </li>
                  <li class="mb-2 d-flex">
                    <i class="fas fa-circle text-dark me-2 mt-1"></i>
                    <span
                      >MENUMBUHKEMBANGKAN KELOMPOK-KELOMPOK USAHA MELALUI BUMDES
                      DAN PEMANFAATAN TEKNOLIGI TEPAT GUNA UNTUK KEMAJUAN
                      EKONOMI</span
                    >
                  </li>
                  <li class="mb-2 d-flex">
                    <i class="fas fa-circle text-dark me-2 mt-1"></i>
                    <span
                      >PENINGKATKAN KEMAMPUAN SDM YANG UNGGUL, BERIMAN DAN
                      BERTAQWA</span
                    >
                  </li>
                  <li class="mb-2 d-flex">
                    <i class="fas fa-circle text-dark me-2 mt-1"></i>
                    <span
                      >PENINGKATAN KUALITAS KETENTRAMAN DAN KETERTIBAN
                  ...
                  <li class="mb-2 d-flex">
                    <i class="fas fa-circle text-dark me-2 mt-1"></i>
                    <span>PENINGKATAN KUALITAS HIDUP MASYARAKAT</span>
                  </li>
                </ul>
              </div>
            </div>
    ...
    <!-- Contact Section -->
    <section id="APB" class="tabel section-title bg-danger">
      <div class="container">
        <h2 class="text-center mb-5">APB Desa</h2>
        <div class="container-fluid">
          <!-- DataTales Example -->
          <div class="card shadow mb-4 table-primary">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-dark">APB Desa</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table
    ...
    <!-- Contact Section -->
    <section id="RKA" class="tabel bg-success mb-5">
      <div class="container">
    ...
    <script>
      $(document).ready(function () {
        $("#dataTableRPJM").DataTable();
      });
      $(document).ready(function () {
        $("#dataTableAPB").DataTable();
      });
      $(document).ready(function () {
        $("#dataTableRKA").DataTable();
      });
    </script>
  </body>
</html>
