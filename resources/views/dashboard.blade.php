    ...
    <div class="row">
      <div class="col-md-3 col-lg-2 sidebar" id="sidebar">
        ...
        <nav class="nav flex-column">
            <a href="/dashboard" class="nav-link active"><i class="fas fa-home"></i> Home</a>
            <a href="/monografi_dashboard" class="nav-link"><i class="fa fa-line-chart"></i> Monografi</a>
      ...
      <div class="col-md-9 col-lg-10 main-content">
        ...
        <div class="card">
          <div class="table-header">Tabel Berita</div>
        ...
        <div class="card">
          <div class="table-header">Tabel Galeri</div>
          <div class="table-responsive">
