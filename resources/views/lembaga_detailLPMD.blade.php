...
<html lang="en">
  ...
  <body>
    ...
    <section id="lembagadetail" class="section-padding bg-light">
      <div class="header section-title">Lembaga Pemberdayaan Masyarakat Desa</div>
      <div class="content">
        <img
          alt="Logo of Badan Permusyawaratan Desa"
          height="150"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRSgUX3S8pbAV9zFzH-nVbMq2eOkO3YlUWN9w&s"
          width="150"
        />
        <div class="details section-title">
          <table>
            <tr>
              <td>Nama Lembaga</td>
              <td>:</td>
              <td>Lembaga Pemberdayaan Masyarakat Desa (LPMD)</td>
            </tr>
            <tr>
              <td>Dasar Hukum / SK Pembentukan</td>
              <td>:</td>
              <td>Peraturan Menteri Dalam Negeri Nomor 18 Tahun 2018 </td>
            </tr>
            <tr>
              <td>Alamat Kantor</td>
              <td>:</td>
      ...
      <div class="section">
          ...
          <div class="content-box">
              Visi :<br> "Terwujudnya masyarakat desa yang mandiri, berdaya saing, dan sejahtera melalui pemberdayaan yang berkelanjutan."

              <br /><br />
              Misi :
              <ol>
                  <li>Mengembangkan kapasitas masyarakat dengan meningkatkan keterampilan, pengetahuan, dan kesadaran masyarakat melalui program pelatihan dan edukasi. </li>
                  <li>Mendorong Kemandirian Ekonomi. Membantu menciptakan peluang usaha dan pengembangan ekonomi berbasis potensi lokal.
                  </li>
                  <li>Meningkatkan Partisipasi Masyarakat. Memfasilitasi keterlibatan aktif masyarakat dalam perencanaan, pelaksanaan, dan evaluasi pembangunan desa.
                  </li>
                  <li>Memperkuat Kerja Sama. Membangun sinergi dengan pemerintah desa, organisasi lokal, dan pihak swasta untuk mendukung program pemberdayaan masyarakat.</li>
                  <li>Mengelola Potensi Desa Secara Berkelanjutan. Mengoptimalkan penggunaan sumber daya alam dan budaya lokal untuk mendukung kesejahteraan masyarakat tanpa merusak lingkungan.
                  </li>
              </ol> 
          </div>
      </div>
      <div class="section">
        ...
        Untuk menggerakkan dan memberdayakan masyarakat desa melalui berbagai program yang bertujuan meningkatkan kualitas hidup dan kesejahteraan mereka. LPMD bertugas merencanakan, melaksanakan, dan mengawasi pelaksanaan program pembangunan yang melibatkan partisipasi aktif masyarakat, baik dalam bidang ekonomi, pendidikan, kesehatan, dan sosial. Fungsi utama LPMD adalah sebagai fasilitator dalam mengorganisir potensi lokal, mengoptimalkan penggunaan sumber daya desa, serta meningkatkan kesadaran masyarakat tentang pentingnya peran mereka dalam pembangunan desa yang berkelanjutan. LPMD juga berfungsi sebagai penghubung antara masyarakat dengan pemerintah desa, serta memastikan bahwa program pembangunan yang dijalankan dapat menciptakan perubahan positif bagi seluruh lapisan masyarakat desa.
