...
<html lang="en">
  ...
  <body>
    ...
    <section id="transparansi" class="produk-hukum bg-secondary">
      <div class="container">
        <h2 class="text-center mb-5">Transparansi Anggaran</h2>
        <div class="container-fluid">
          <!-- DataTales Example -->
          <div class="card shadow mb-4 table-primary">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-dark">Transparansi Anggaran</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table
                  class="table table-bordered"
                  id="dataTableTransparansi"
                  width="100%"
                  cellspacing="0"
                >
                  <thead>
    ...
    <script>
      $(document).ready(function () {
        $("#dataTableTransparansi").DataTable(
          {
            pageLength: 5,
