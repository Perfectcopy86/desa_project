...
<html lang="en">
  ...
  <body>
    ...
    <section id="lembagadetail" class="section-padding bg-light">
      <div class="header-lembaga section-title">BADAN PERMUSYAWARATAN DESA</div>
      <div class="content-lembaga">
        <img
          alt="Logo of Badan Permusyawaratan Desa"
          height="150"
          src="https://desa-puncak.kuningankab.go.id/sites/des1858/files/hamalan/LOGO-BPD.png"
          width="150"
        />
        <div class="details section-title">
          <table>
            ...
            <tr>
              ...
              <td>:</td>
              <td>Peraturan Menteri Dalam Negeri Nomor 110 Tahun 2016</td>
            </tr>
            <tr>
              <td>Alamat Kantor</td>
              <td>:</td>
      ...
      <div class="section">
          ...
          <div class="content-box">
              Visi :<br> "Terwujudnya tata kelola pemerintahan desa yang transparan,
              akuntabel, dan partisipatif demi meningkatkan kesejahteraan masyarakat
              desa secara berkelanjutan."
              <br /><br />
              Misi :
              <ol>
                  <li>Meningkatkan partisipasi masyarakat. </li>
                  <li>Mengawasi kinerja pemerintah desa secara transparan untuk memastikan pengelolaan keuangan desa yang bertanggung jawab.</li>
                  <li>Membangun kerja sama yang harmonis antara pemerintah desa, masyarakat, dan pihak lain untuk mendukung keberlanjutan pembangunan.</li>
                  <li>Mendorong penguatan kapasitas desa melalui menginisiasi pelatihan dan edukasi bagi aparatur desa serta masyarakat untuk meningkatkan pemahaman terhadap hak dan kewajiban dalam tata kelola desa.</li>
                  <li>Mengawal regulasi desa dengan memastikan bahwa peraturan desa dibuat sesuai dengan kebutuhan masyarakat dan prinsip-prinsip hukum yang berlaku.
                  </li>
              </ol> 
          </div>
      </div>
      <div class="section">
        ...
        Untuk membantu pemerintah desa dalam menjalankan fungsi pemerintahan yang partisipatif, transparan, dan akuntabel. BPD bertugas merumuskan dan menyetujui peraturan desa bersama dengan kepala desa, serta mengawasi jalannya pelaksanaan kebijakan dan program pemerintah desa agar sesuai dengan kebutuhan masyarakat. Selain itu, BPD juga berfungsi sebagai saluran aspirasi masyarakat, menampung, menyampaikan, dan mengadvokasi kepentingan warga desa dalam setiap kebijakan yang diambil. BPD memiliki peran penting dalam memastikan partisipasi masyarakat dalam pembangunan desa, mengawasi pengelolaan keuangan desa, serta menjalin komunikasi yang baik antara pemerintah desa dan masyarakat untuk menciptakan tata kelola pemerintahan yang efektif dan responsif.
