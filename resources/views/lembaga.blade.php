...
<html lang="en">
  ...
  <body>
    ...
    <!-- Institutions -->
    <section id="institutions" class="lembaga bg-light">
      <div class="container">
        <h2 class="text-center mb-5">Lembaga-lembaga</h2>
        <p class="justify-text">
          Sesuai dengan amanat Undang-Undang dan Peraturan Menteri Dalam Negeri,
          dalam melaksanakan tugas-tugas pokok dan fungsinya untuk memenuhi
          kepentingan dan kebutuhan masyarakat, Desa memiliki lembaga-lembaga
          yang ada di Desa yang bertujuan membantu Perbekel / Kepala Desa dan
          unsur perangkat desa dalam melaksanakan program-program kerja sebagai
          wujud implementasi Visi Misi Desa maupun Visi Misi Perbekel.
        </p>
        <br />
        <h4>Adapun lembaga-lembaga yang ada di Desa, antara lain :</h4>
      </div>
      <div class="container text-center py-5">
        <div class="row">
          <div class="col-md-4 mb-4">
            <a href="/lembaga_detailBPD" style="text-decoration: none; color: inherit;">
              <div class="logo-container">
                <img
                  ...
                  class="logo-img"
                />
                <h4 class="mt-3">Badan Permusyawaratan Desa (BPD)</h4>
              </div>
            </a>
          </div>
          <div class="col-md-4 mb-4">
            <a href="/lembaga_detailLPMD" style="text-decoration: none; color: inherit;">
              <div class="logo-container">
                <img
                  ...
                  class="logo-img"
                />
                <h4 class="mt-3">Lembaga Pemberdayaan Masyarakat Desa (LPMD)</h4>
              </div>
            </a>
          </div>
          <div class="col-md-4 mb-4">
            <a href="/lembaga_detailPKK" style="text-decoration: none; color: inherit;">
              <div class="logo-container">
                <img
                  ...
                  class="logo-img"
                />
                <h4 class="mt-3">Pembinaan Kesejahteraan Keluarga (PKK)</h4>
              </div>
            </a>
          </div>
          <div class="col-md-4 mb-4">
            <a href="/lembaga_detailKT" style="text-decoration: none; color: inherit;">
              <div class="logo-container">
                  ...
                  <img
                    ...
                    class="logo-img"
                  />
                  <h4 class="mt-3">Karang Taruna</h4>
              </div>
            </a>
          </div>
          <div class="col-md-4 mb-4">
            <a href="/lembaga_detailLD" style="text-decoration: none; color: inherit;">
              <div class="logo-container">
                <img
                  ...
                  class="logo-img"
                />
                <h4 class="mt-3">Linmas Desa</h4>
              </div>
            </a>
          </div>
          <div class="col-md-4 mb-4">
            <a href="/lembaga_detailBD" style="text-decoration: none; color: inherit;">
              <div class="logo-container">
                <img
                  src="https://profil.bumdes.id/upload/1593090476446.png"
                  alt="BUMDes Logo"
                  class="logo-img"
                />
                <h4 class="mt-3">Badan Usaha Milik Desa (BUMDes)</h4>
              </div>
            </a>
          </div>
        </div>
