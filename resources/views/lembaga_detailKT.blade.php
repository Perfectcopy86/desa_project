...
<html lang="en">
  ...
  <body>
    ...
    <section id="lembagadetail" class="section-padding bg-light">
      <div class="header section-title">Karang Taruna</div>
      <div class="content">
        <img
          alt="Logo of Badan Permusyawaratan Desa"
          height="150"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNsBZVRkmEbz7-MdvcDGxcdzypBGlnCuAe2w&s"
          width="150"
        />
        <div class="details section-title">
          <table>
            ...
            <tr>
              ...
              <td>:</td>
              <td>Peraturan Menteri Sosial No. 77 Tahun 2010</td>
            </tr>
            <tr>
              <td>Alamat Kantor</td>
              <td>:</td>
      ...
      <div class="table-section">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td>Sekretaris</td>
              <td>Muhammad Putra Kurniawan
              </td>
            </tr>
            <tr>
              <td>Bendahara</td>
              <td>Anindya Putri Kusumadewi
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <div class="section">
          ...
          <div class="content-box">
              Visi :<br> "Terwujudnya generasi muda desa yang kreatif, mandiri, berintegritas, dan berperan aktif dalam pembangunan masyarakat."
              <br /><br />
              Misi :
              <ol>
                  <li>Meningkatkan kapasitas pemuda</li>
                  <li>Mendorong kreativitas untuk berinovasi dalam bidang seni, budaya, teknologi, dan kewirausahaan.</li>
                  <li>Memperkuat solidaritas sosial  untuk membantu masyarakat yang membutuhkan, serta mempererat hubungan antarwarga.</li>
                  <li>Membangun kemandirian ekonomi bersama berbasis potensi lokal untuk menciptakan lapangan kerja dan meningkatkan ekonomi pemuda desa.</li>
                  <li>Menanamkan nilai-nilai kebangsaan, keagamaan, dan budaya lokal sebagai fondasi pembangunan karakter.</li>
                  <li>Berperan aktif dalam pembangunan desa dengan Menjadi mitra pemerintah desa dalam merencanakan dan melaksanakan program-program pembangunan yang melibatkan pemuda.</li>
              </ol> 
          </div>
      </div>
      <div class="section">
        ...
        Untuk memberdayakan generasi muda desa melalui berbagai kegiatan sosial, pendidikan, dan ekonomi yang dapat meningkatkan kualitas kehidupan mereka. Karang Taruna bertugas merencanakan, melaksanakan, dan mengawasi program-program pemberdayaan pemuda, seperti pelatihan keterampilan, kewirausahaan, dan pengembangan kreativitas, serta kegiatan sosial yang membantu masyarakat desa. Fungsi utamanya adalah sebagai penggerak partisipasi pemuda dalam pembangunan desa, mempererat solidaritas sosial, dan memperkuat nilai-nilai kebangsaan serta budaya lokal. Karang Taruna juga berperan sebagai mitra pemerintah desa dalam merancang dan menjalankan program pembangunan yang melibatkan pemuda, serta mendukung terciptanya pemuda yang mandiri, kreatif, dan berperan aktif dalam pembangunan masyarakat desa.
