<html lang="en">
  ...
  <body>
    ...
    <div class="content-layanan container">
        <div class="row">
            <div class="col-md-4">
                <img
            ...
            <div class="col-md-8">
                <div class="info-box">
                    <h5>Info Pelayanan Desa Tangsimekar</h5>
                    <p>
                        Selamat datang di halaman "Informasi Pelayanan" Desa
                        kami! Di sini, Anda dapat menemukan informasi lengkap
                        terkait berbagai layanan yang disediakan oleh pemerintah
                        desa untuk mendukung kebutuhan masyarakat. Kami
                        berkomitmen untuk memberikan pelayanan yang cepat,
                        transparan, dan ramah, demi terciptanya desa yang maju
                        dan sejahtera.
                    </p>
                    <p>
                    ...
                    <ol>
                        ...
                        <li>Layanan Kesehatan dan Sosial.</li>
                        <li>Pelayanan Perizinan.</li>
                        <li>Informasi Pendidikan dan Pelatihan.</li>
                        <li>Pengaduan dan Aspirasi Masyarakat.</li>
                        <li>Dan layanan lainnya.</li>
                    </ol>
                    <p>
                        Silakan telusuri halaman ini untuk informasi lebih
                        lanjut atau hubungi kantor desa kami melalui nomor
                        kontak atau tombol pusat bantuan yang tersedia. Kami
                        hadir untuk melayani Anda dan siap membantu segala
                        kebutuhan Anda terkait administrasi maupun layanan
                        lainnya di desa.
                    </p>
                </div>
            </div>
