...
<body>
    ...
    <div class="row">
      ...
      <div class="col-md-9 col-lg-9 main-content">
        ...
        <div class="card">
          ...
          <div class="table-responsive">
            <table id="table-transparansi" class="table align-middle">
              ...
              <tbody class="table-body">
                <tr>
                  <td>1</td>
                  <td>FORMAT RPJM KOTA SDGs-permendes21</td>
          ...
          <!-- Pagination -->
          <ul id="pagination-table-transparansi" class="pagination">
  ...
  <script src="../assets/js/Admin/transparansi.js"></script>
